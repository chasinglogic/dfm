...
func GenerateSymlinks(profileDir, target string) []utils.LinkInfo {
	var lnks []utils.LinkInfo
	...
	for _, file := range files {
		...
		lnks = append(lnks, *utils.GenerateSymlink(profileDir, target, file, false))
	}
